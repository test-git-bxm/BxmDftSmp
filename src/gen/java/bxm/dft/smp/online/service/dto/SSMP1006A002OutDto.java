...
public class SSMP1006A002OutDto implements IOmmObject, Predictable, FieldInfo
{
	 ...
	 */
	@JsonProperty("size")
	@BxmOmm_Field(length=9, decimal=0, description="리스트사이즈", align="right", fill="")
	...
	@BxmOmm_Field(length=0, decimal=0, description="직원리스트", align="left", fill="", arrayReference="size")
